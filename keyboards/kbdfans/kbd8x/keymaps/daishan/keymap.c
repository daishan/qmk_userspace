...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN2] = LAYOUT_tkl_ansi(
        ...
        _______, SHRUG,   POOP,    FLIPTAB, FLIPTA2, THUMBUP, _______, _______, _______, _______, _______,  _______, UC_LINX,  UC_MAC,      _______, _______, _______,
        _______,  KC_MUTE, KC_VOLU, RGBSWRL, UG_NEXT, UG_HUEU, UG_HUED, UG_SATU, UG_SATD, UG_VALU, UG_VALD, UG_SPDU, UG_SPDD,  QK_BOOT,     _______, KC_MUTE, _______,
        _______,   KC_MPRV, KC_VOLD, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,    _______, BL_DOWN, BL_TOGG, BL_UP,   BL_STEP, _______, _______, MS_WHLU, MS_WHLD, UC_NEXT,                  KC_MPLY,              KC_VOLU,
        TG(OSX),    TG(CAP),    _______,                      TG(GAM),                      _______,    __F13__,    _______,   UG_TOGG,     KC_MPRV, KC_VOLD, KC_MNXT),

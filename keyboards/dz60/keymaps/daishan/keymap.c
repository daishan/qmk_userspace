...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [OSX] = LAYOUT_60_ansi(
        ...
        KC_LGUI,    KC_LCTL,    _______,                      _______,                      _______,    MO(FNO),    _______,   _______),
    ...
    [FNO] = LAYOUT_60_ansi(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______,
        _______,  APP_001, _______, APP_002, APP_003, _______, _______, _______, _______, _______, _______, _______, _______,  _______,
        _______,   _______, _______, _______, APP_004, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______,    _______, _______, APP_005, APP_006, _______, _______, _______, _______, _______, _______,                  _______,
